...
function Desinstalar {
    ...
    # Se busca por la RUTA de la carpeta instalada, no por la palabra "AppPack"
    ...
    #
    # Antes de eso se comprueba que sea de verdad una instalación de AppPack.
...
$ventana.Text = "Desinstalar AppPack"
...
$rutaIcono = Join-Path $destino "AppPack.ico"
...
$cuerpo.Controls.Add((Texto "¿Desinstalar AppPack?" 32 34 460 30 $Tinta (Letra 14)))
...
$aceptar.Add_Click({
    ...
    $cuerpo.Controls.Clear()
    $cuerpo.Controls.Add((Texto "AppPack se desinstaló" 32 40 456 30 $Tinta (Letra 14)))
